  ...
  return (
    <svg aria-hidden="true" viewBox="0 0 200 40" {...props}>
      <path
        ...
        fill="#2563EB"
      />
      <text x="50" y="28" fontFamily="sans-serif" fontSize="24" fontWeight="bold" fill="#0F172A">Part</text>
      <text x="100" y="28" fontFamily="sans-serif" fontSize="24" fontWeight="bold" fill="#2563EB">Soft</text>
    </svg>
  );
}
